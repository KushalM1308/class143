...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://dcb0-150-129-104-121.in.ngrok.io"
    }
  }
  ...
  /*define likedMovie() function here*/
  likedmovie=()=>{
    const url = this.state.ngrok_url.url + '/like'
    axios.get(url).then((response)=>{
      this.getmovie()
    }).catch((error)=>{
      alert(error)
  ...
  /*define dislikedMovie() function here*/
  dislikedmovie=()=>{
  ...
  /*define notWatched() function here*/
  notwatchedmovie=()=>{
  ...
  render() {
     ...
     if(movieDetails.poster_link){
      const {poster_link,duration,original_title,rating,release_date} = movieDetails;
      return (
